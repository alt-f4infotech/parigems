...
<section class="main-section">
    <div class="container-fluid crumb_top">
      ...
      <li class="active">View Colors</li>
		...
		<ul id="myTab" class="nav nav-tabs nav-tabs-bg">
        	<li class="active"><a href="#view"  data-target="#view" data-toggle="tab">View Colors</a></li>
        	<li><a href="#add" data-target="#add" data-toggle="tab" >Add Color</a></li>
    	</ul>
	...
	<div id="toolbar">
            <select class="form-control">
			   ...
			   data-show-columns="true">
                     ...
                     <tbody>
                        <?php
                           $i=1;
							 $certificteqry1="select * from color";
			...
			<div id="add" class="tab-pane fade">
				<br>
				<form id="msform" class="form-horizontal" action="insertcolor.php" enctype="multipart/form-data" method="post" >
      <fieldset >
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="form-group">                  
                  ...
                  <div class="col-sm-10">   
                    <input type="text" name="name" id="name" onblur="optionvalidate('color');" tabindex="1" required class="form-control">
                  </div>
                </div>
              </div>
            </div>
...
function block(i) {
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","deletecolor.php?id="+i, true);
   		 http2.send(null);
    }
		 });
        }
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","unblockcolor.php?id="+i, true);
   		 http2.send(null);
    }
			 });
        }
