...
<section class="main-section">
    <div class="container-fluid crumb_top">
      ...
      <li class="active">View Black Inclusion</li>
   </ol>
		<ul id="myTab" class="nav nav-tabs nav-tabs-bg">
        	<li class="active"><a href="#view"  data-target="#view" data-toggle="tab">View Black Inclusion</a></li>
        	<li><a href="#add" data-target="#add" data-toggle="tab" >Add Black Inclusion</a></li>
    	</ul>
	...
	<div id="toolbar">
			   ...
			   data-show-columns="true">
						<thead>
						  ...
						  <th data-field="state" data-checkbox="true" ></th>
                           ...
                           <th data-sortable="true">Black Inclusion Name</th>
                     ...
                     <tbody>
                        <?php
                           $i=1;
							 $certificteqry1="select * from black_inclusion";
							...
							echo '<td></td>';
                           	echo "<td>".$i++."</td>";
                           	echo "<td>".$row['blackinclusionname']."</td>";
                           	echo "<td>".$status1."</td>";
							if($status=='0'){ ?>
			...
			<div id="add" class="tab-pane fade">
				<br>
				<form id="msform" class="form-horizontal" action="insertblck.php" enctype="multipart/form-data" method="post" >
      <fieldset >
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="form-group">                  
                  <label class="control-label col-sm-2">Black Inclusion Name</label>
                  <div class="col-sm-10">   
...
function block(i) {
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","deleteblck.php?id="+i, true);
   		 http2.send(null);
    }
		 });
        }
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","unblockblck.php?id="+i, true);
   		 http2.send(null);
    }
			 });
        }
