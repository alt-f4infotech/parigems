...
<section class="main-section">
    <div class="container-fluid crumb_top">
      ...
      <li class="active">View Milky</li>
   </ol>
		<ul id="myTab" class="nav nav-tabs nav-tabs-bg">
        	<li class="active"><a href="#view"  data-target="#view" data-toggle="tab">View Milky</a></li>
        	<li><a href="#add" data-target="#add" data-toggle="tab" >Add Milky</a></li>
    	</ul>
	...
	<div id="toolbar">
			   ...
			   data-show-columns="true">
						<thead>
						  ...
						  <th data-field="state" data-checkbox="true" ></th>
                           ...
                           <th data-sortable="true">Milky Name</th>
                     ...
                     <tbody>
                        <?php
                           $i=1;
							 $certificteqry1="select * from milky";
			...
			<div id="add" class="tab-pane fade">
				<br>
				<form id="msform" class="form-horizontal" action="insertmilky.php" enctype="multipart/form-data" method="post" >
      <fieldset >
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="form-group">                  
                  <label class="control-label col-sm-2">Milky Name</label>
                  <div class="col-sm-10">   
                    <input type="text" name="name" id="name" onblur="optionvalidate('milky');" tabindex="1" required class="form-control">
                  </div>
                </div>
              </div>
            </div>
...
function block(i) {
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","deletemilky.php?id="+i, true);
   		 http2.send(null);
    }
		 });
        }
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","unblockmilky.php?id="+i, true);
   		 http2.send(null);
    }
			 });
        }
