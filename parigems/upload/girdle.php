...
<section class="main-section">
    <div class="container-fluid crumb_top">
      ...
      <li class="active">View Girdle Condition</li>
   </ol>
		<ul id="myTab" class="nav nav-tabs nav-tabs-bg">
        	<li class="active"><a href="#view"  data-target="#view" data-toggle="tab">View Girdle Condition</a></li>
        	<li><a href="#add" data-target="#add" data-toggle="tab" >Add Girdle Condition</a></li>
    	</ul>
	...
	<div id="toolbar">
			   ...
			   data-show-columns="true">
						<thead>
						  ...
						  <th data-field="state" data-checkbox="true" ></th>
                           ...
                           <th data-sortable="true">Girdle Condition Name</th>
                     ...
                     <tbody>
                        <?php
                           $i=1;
							 $certificteqry1="select * from girdle";
			...
			<div id="add" class="tab-pane fade">
				<br>
				<form id="msform" class="form-horizontal" action="insertgirdle.php" enctype="multipart/form-data" method="post" >
      <fieldset >
        <div class="row">
          <div class="col-sm-12">
            <div class="row">
              <div class="col-xs-12">
                <div class="form-group">                  
                  <label class="control-label col-sm-2">Girdle Condition Name</label>
                  <div class="col-sm-10">   
                    <input type="text" name="name" id="name" onblur="optionvalidate('girdle');" tabindex="1" required class="form-control">
                  </div>
                </div>
              </div>
            </div>
...
function block(i) {
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","deletegirdle.php?id="+i, true);
   		 http2.send(null);
    }
		 });
        }
   ...
   if (http2.readyState==4 )
   		 ...
   		 http2.open("GET","unblockgirdle.php?id="+i, true);
   		 http2.send(null);
    }
			 });
        }
