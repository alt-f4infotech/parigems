...
$certificteqry1="select i.*,d.*,dp.rap,dp.final from add_to_cart_search i,diamond_master d,diamond_sale dp where d.diamond_id=dp.diamond_id  and i.diamondid=d.diamond_id and i.userid='$userid' and i.wishstatus='1'";
//echo $certificteqry1;
			  ...
			  if($raprow['rap']!='0'){
			      echo "<tr class='$class'>
			      <input style='display:none' type='checkbox' name='check[]'   value='".$did."'checked />";
		...
		<input type="text" style="display: none;" name="userdiscount[]"   value="<?php echo $Discount;?>"  />
