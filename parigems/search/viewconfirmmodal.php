...
$certificteqry1="select i.*,d.*,dp.rap,dp.final from add_to_cart i,diamond_master d,diamond_sale dp where d.diamond_id=dp.diamond_id  and i.diamondid=d.diamond_id and i.userid='$userid' and i.cartstatus='1' and d.diamond_id=".$didarray[$d];
//echo $certificteqry1;
