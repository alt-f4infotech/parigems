...
$certificteqry1="select i.*,d.*,dp.rap,dp.discount1,dp.discount2,dp.discount3,dp.final from diamond_status i,diamond_master d,diamond_sale dp where d.diamond_id=dp.diamond_id and i.diamondid=d.diamond_id and i.userid='$userid' and i.diamond_status='HOLD' and d.diamond_id=".$didarray[$d];
//echo $certificteqry1;
