...
switch($_GET["action"]) {
	...
	case "wish":
		$getcarttable1="select * from add_to_cart where userid='$userid' and wishstatus='1'";
	...
	while($wrow=mysqli_fetch_assoc($cartres1))
	{
		$dimndid=$wrow['diamondid'];
			...
			$insertcart="INSERT INTO `wishlist`(`userid`, `diamondid`, `wishstatus`, `timestamp`) VALUES ('$userid','$dimndid','1',NOW())";
	...
	case "hold":
		$getcarttable="select * from add_to_cart where userid='$userid' and wishstatus='1'";
...
echo '<script>window.location.href="searchdiamond.php";</script>';
				...
				}else{ echo '<script>window.location.href="searchdiamond.php";</script>';}
		}
	 ...
	 if(mysqli_query($con,$insertmessage))
	 {
	  ...
	  $insertmessageTouser="INSERT INTO `notification`( `message`, `userid`, `status`, `entrydate`,`reminderdate`) VALUES ('$text','$adminId','1',NOW(),'$reminderdate')";
   ...
   case "unhold":		
				$dimndid=$_GET['code'];
				$updateqry2="Update diamond_status set diamond_status='UNHOLD',userid='$userid',unholdtime=NOW() where diamondid=$dimndid";
...
if($milkyfrom!='' && $milkyto!='')
 ...
 if($certificateno!='')
   ...
   if($priceFrom!='')
   {
	$qry51="and s.rap >= $priceFrom";
   }
   if($priceTo!='')
   {
	$qry52="and s.rap <= $priceTo";
   }
...
width: 100%;*/
		...
		<form id="movieForm" action="placeorder.php" method="post">
			<div class="row" id="fixed" style="position: fixed; top: 78px; background-color: #fff; width: 100%;    -webkit-box-shadow: -1px 3px 21px 1px rgba(0,0,0,0.75);
    -moz-box-shadow: -1px 3px 21px 1px rgba(0,0,0,0.75);
    box-shadow: -1px 3px 44px 1px rgba(0,0,0,0.75);padding-top: 15px">
        ...
        echo '<table class="table table-bordered carttable" align="center" id="carttatble" style="font-size:9px;">
		   ...
		   <div class="col-lg-6 col-sm-6" id='hideguest' style="margin-top:2%">
		 <a href="search.php?modify=<?php echo encrypt_decrypt('encrypt','modify');?>" class="btn btn-info">Modify Search</a>
         <a class="btn btn-danger"  href="sendaction.php?action=reset">Reset</a>
         <a class="btn btn-success"  href="sendaction.php?action=finaladd">Add To Cart</a>
		 <?php if($holdcountt > 1){}else{ ?>
         <a class="btn btn-warning"  href="searchdiamond.php?action=hold" id="holdid">Hold</a>
		 <?php } ?>
         <!--<a class="btn btn-primary"  href="../search/holded.php">View Holded Diamonds</a>-->
         <a class="btn btn-danger"  href="searchdiamond.php?action=wish">Watchlist</a>
		 <?php 
         ...
         <a class="btn btn-info"  href="viewcart.php">View Cart <span class="badge"><?php echo $viewcartcount;?></span></a>
		  ...
		  <div class="modal fade" id="confirmModal" role="dialog" style="z-index: 10000;">
			<div class="modal-dialog">
			  <!-- Modal content-->
			  <div class="modal-content border-radius0" style="width: 868px;">
      ...
      <span>
	   ...
	   <!-- <table class="table"   data-search="true" style="font-size:10px;margin-top:6%;">
      <thead>-->
			...
			<td>
			  <div style="width:1342px;font-size:small">
				<table class="table table-stripped" cellspacing="0" cellpadding="0" style="font-size:10px;">
					 <tr class="tableHead">
						<?php if($role!='GUEST'){ ?>
						<th class="thPlus"  data-field="state"></th>
						<?php } ?>
						<!--<th class="thPlus"  data-sortable="true">Sr.No.</th>-->
						<th class="thPlus"  data-sortable="true">View</th>				 
						<th class="thPlus"  data-sortable="true" title="PG Stock Id">Stock Id</th>
						<th class="thPlus"  data-sortable="true" title="Shape">Shape</th>
						<th class="thPlus"  data-sortable="true" title="Lab">Lab</th>
						<th class="thPlus"  data-sortable="true" title="Certificate">Certificate</th>
						<th class="thPlus"  data-sortable="true" title="Size/Carat">Size</th>
						<th class="thPlus"  data-sortable="true" title="Color">Color</th>
						<th class="thPlus"  data-sortable="true" title="Clarity">Clarity</th>
						<th class="thPlus"  data-sortable="true" title="Cut">Cut</th>
						<th class="thPlus"  data-sortable="true" title="Polish">Polish</th>
						<th class="thPlus"  data-sortable="true" title="Symmetry">Symm.</th>
						<th class="thPlus"  data-sortable="true" title="Fluorsence">Flr</th>
						<th class="thPlus"  data-sortable="true" title="Rap Rate">Rap $</th>
						<th class="thPlus"  data-sortable="true" title="Discount">&#177; Dis</th>
						<th class="thPlus"  data-sortable="true" title="Per Carat Rate">P/C $</th>
						<th class="thPlus"  data-sortable="true" title="Final Amount">Amount$</th>
						<th class="thPlus"  data-sortable="true" title="Depth">Depth</th>  
						<th class="thPlus"  data-sortable="true" title="Table">Table</th> 
					   <th class="thPlus"  data-sortable="true" title="Measurement">Measurement</th>              
					   <th class="thPlus"  data-sortable="true" title="H & A">H & A</th>              
					   <th class="thPlus"  data-sortable="true" title="Milky">Milky</th>             
					   <th class="thPlus"  data-sortable="true" title="Brown Inclusion">Br.I</th>             
					   <th class="thPlus"  data-sortable="true" title="Black Inclusion">Bl.I</th>             
					   <th class="thPlus"  data-sortable="true" title="Location">Location</th>
					   <th class="thPlus" >Timer</th>
