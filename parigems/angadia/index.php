...
<div class="container-fluid">
   ...
   <div class="col-xs-12 col-sm-12 col-md-3 col-lg-6">
      <a href="angadia_payment_receipt.php" class="thumbnail" >
      <img src="../images/CREATE_PAYMENT_CUSTOMER.png" alt="...">
      </a>
   </div>
   <div class="col-xs-12 col-sm-12 col-md-3 col-lg-6">
      <a href="view_alldeposit.php" class="thumbnail" >
      <img src="../images/VIEWPAYMENT_CUSTOMET.png" alt="...">
      </a>
   </div>
   <div class="col-xs-12 col-sm-12 col-md-3 col-lg-6">
      <a href="angadia_debit_voucher.php" class="thumbnail" >
      <img src="../images/CREATE_DEBIT_PURCHASERS.png" alt="...">
      </a>
   </div>
   <div class="col-xs-12 col-sm-12 col-md-3 col-lg-6">
      <a href="view_allexpense.php" class="thumbnail" >
