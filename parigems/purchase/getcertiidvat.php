            ...
            <div class="form-group">
              ...
              <div class="table-responsive">
               ...
               <table class="table table-condensed" id="table" data-height="400" data-toggle="table" data-search="true">
                  ...
                  <?php
                   $k=1;$error=0;
                    $getid="select * from diamond_master";
                    $result=mysqli_query($con,$getid);
                      while($c=mysqli_fetch_assoc($result))
                     {
                    $getid1="select pp.* from purchaseinvoice_product pp,purchaseinvoice p where p.purchase_invoiceid=pp.purchase_invoiceid and p.purchasestatus='1' and pp.diamond=".$c['diamond_id'];
                ...
                <input type="button" value="submit" id="modalButton" data-dismiss="modal" onclick="putidvat(<?php echo $id;?>,<?php echo $k;?>)" class="btn btn-success">
            </div>
            </div>
          </div>
        </div>
