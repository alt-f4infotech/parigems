          ...
          <div class="col-sm-12">
            <div class="form-group">
              ...
              <div class="table-responsive">
                  ...
                  <?php
                   $k=1;$error=0;
                    ...
                    $result=mysqli_query($con,$getid);
                     ...
                     {
                    $getid1="select * from purchaseinvoice_product where diamond=".$c['diamond_id'];
                    ...
                    echo "<input type='text' value='".$rrow['inr']."' style='display:none;' id='purchaserate_$k'>";
                    $k++;  }
                    }
                    }
                    if($error > 0)
                ...
                <input type="button" value="submit" data-dismiss="modal" onclick="putid(<?php echo $id;?>,<?php echo $k;?>)" class="btn btn-success">
              </div>
            </div>
            </div>
          </div>
...
<!--<script src="../js/purchaseregular1.js"></script>-->