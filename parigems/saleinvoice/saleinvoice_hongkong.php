...
?>
  ...
  <div class="container-fluid crumb_top">
    <ol class="breadcrumb" id="breadcrumb" style="color: black">
      ...
      <li class="active">Sale Invoice Hongkong</li>
    </ol>
    <h2 class="text-center">Sale Invoice Hongkong</h2>
		   ...
		   ?>
            <tr>
             ...
             <td><input type="text" name="lab[]" id="lab_1" value="<?php echo $lab;?>" class="form-control" readonly></td>
              ...
              <td><input type="text" name="rate[]" id="rate_1" value="<?php echo $rap;?>" class="form-control" readonly></td>
              <td><input type="text" name="amount[]" id="amount_1" value="<?php echo sprintf("%.2f",$row['amount']);?>" class="form-control" readonly></td>
			  <input type="text" style="display:none" name="userid" value="<?php echo $uniqueuserid;?>">
			  <input type="text" style="display:none" name="invoicetype" value="Hongkong">
			...
			<?php } ?>
                ...
                <input type="text" name="vat" id="vat" value='0' style="display:none">
                <input type="text" name="vatamount" id="vatamount" value='0' style="display:none">
		  <tfoot>
            <tr>
			 <td colspan="5"></td>
			  <td><label>Subtotal (in $)</label></td>
			  <td>
                <input class="form-control" tabindex="-1" value="<?php echo sprintf("%.2f",$finaltotal);?>" type="text" name="subtotal" id="subtotal" required readonly>
              </td>
			</tr>		
			<tr>
			 <td colspan="5"></td>
			...
			<tr>
			 <td colspan="5"></td>
			  ...
			  <td>                
                <input class="form-control" type="text" name="roundoff"  value="<?php echo sprintf("%.2f",($finaltotal-round($finaltotal)));?>" id="roundoff" readonly>
              </td>
			</tr>	
			<tr>
			 <td colspan="5"></td>
