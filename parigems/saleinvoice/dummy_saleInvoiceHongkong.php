...
?>
  ...
  <div class="container-fluid">
    <ol class="breadcrumb" id="breadcrumb" style="color: black">
      ...
      <li class="active">Dummy Sale Invoice Hongkong</li>
    </ol>
    <h2 class="text-center">Dummy Sale Invoice Hongkong</h2>
    <form action="insertDummySaleinvoice.php" method="post">
	  <input type="hidden" name="invoiceType" value="Hongkong">
  			<div class="row">
  				<div class="col-sm-4">
				...
				<div class="col-sm-4">
				   <div class="form-group">
					<label><b>Company Name:</b></label><input type="text" name="companyName" class="form-control customerName" id="companyName" data-type="companyname" required>
					</div>
				</div>
				<div class="col-sm-4">
				  <div class="form-group">
