...
?>
  ...
  <div class="container-fluid">
    <ol class="breadcrumb" id="breadcrumb" style="color: black">
      ...
      <li class="active">Dummy Sale Invoice With VAT</li>
    </ol>
    <h2 class="text-center">Dummy Sale Invoice With VAT</h2>
    <form action="insertDummySaleinvoice.php" method="post">
	   <input type="hidden" name="invoiceType" value="WithVat">
  			<div class="row">
  				<div class="col-sm-4">
				...
				<div class="col-sm-4">
				  <div class="form-group">
					<label><b>Contact Number:</b></label><input type="text" name="contactNumber" class="form-control customerName" id="phoneno" data-type="phoneno" >
				  </div>
				</div>
  			</div>
  		   <div class="row">
