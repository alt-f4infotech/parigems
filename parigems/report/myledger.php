...
<section class="main-section">
  <div class="container-fluid">
    <ol class="breadcrumb" id="breadcrumb" style="color: black">
      ...
      <li class="active">My Ledger Report</li>
    </ol>
  </div>
  <div class="container">    
    <div class="row">
      ...
      <div class="row">
        <div class="form-group col-lg-12">
          <input type="hidden" name="customername"  id="customername" class="form-control" value="<?php echo $userid;?>" required>
        </div>
      </div>
    </div>
    <div class="form-group col-lg-12">
...
<script>
  ...
  function reset() {  
  window.location.href="myledger.php";
  }
  function showdiv()
  {
  ...
  if (http2.readyState==4 )
     ...
     var res="&fromDate="+fromDate+"&toDate="+toDate+"&customername="+customername;  
     http2.open("GET","show_custledger.php?res="+res, true);
     http2.send(null);
  }
  else
  {
