<?php
 ...
 $regular_invoice="select * from  purchaseinvoice_dummy where ptype='regular' and purchasestatus='1'";
...
<section class="main-section">
   <div class="container-fluid crumb_type">
        ...
        <table class="table table-bordered table-hover" id="table">
          ...
          <tbody>
            <tr>
              ...
              <td>  
                <input type="text" value="1" name="pcs[]" id="pcs_1" class="form-control"  onkeypress="return IsNumeric(event);" >
              </td>
              <td>
