...
<section class="main-section">
	<div class="container-fluid"> 
	    ...
	    <h3 class="text-left">Edit Purchase Entry(<?php echo $ptype;?>)</h3>
	    <hr>
        ...
        <div class="col-sm-4">
         ...
         <div class='col-xs-4'>
            <div class="form-group">
               ...
               <label><?php //echo $InvoiceDetails['invoiceno']; ?></label><br>-->
   ...
   <strong>Error!</strong> Invoice Number already exists for this Party.
		 ...
		 <div class='col-xs-4'>
            <div class="form-group">
			 ...
			 <!--<td>
                <input type="text" name="clarity[]" value="<?php echo $clarity;?>" id="clarity_1" class="form-control" readonly>
              </td>
			  <td>
                <input type="text" name="cut[]" value="<?php echo $cut;?>" id="cut_1" class="form-control" readonly>
              </td>
			  <td>
                <input type="text" name="polish[]" value="<?php echo $polish;?>" id="polish_1" class="form-control" readonly>
              </td>
			  <td>
                <input type="text" name="symmetry[]" value="<?php echo $symmetry;?>" id="symmetry_1" class="form-control" readonly>
              </td>-->
              <td>
			  ...
			  <!--<td>
                <input type="text" value="<?php echo $row["discount"];?>" name="discountt[]" id="discountt_<?php echo $i;?>" class="form-control d2 totaldiacount"  onkeypress="return IsNumeric(event);" >
              </td>-->
              <td>
