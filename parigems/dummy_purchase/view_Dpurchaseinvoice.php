<?php
   ...
   $invoicenoaa = $encrypted_txt;
     ...
     p.discount as pdiscount,p.vat as pvat,p.*,
	  ...
	  d.*
   FROM
      `purchaseinvoice_product_dummy` pp,
      purchaseinvoice_dummy p,
      party pt,
      location_master l,
...
<div class="container">
   <ol class="breadcrumb" >
      ...
      <li><a href="viewallDummypurchase.php">View All Purchase Invoice</a></li>
            ...
            <?php
              $PurchaseInvoiceResult2 = mysqli_query($con,$PurchaseInvoiceQuery);
               ...
               while($row=mysqli_fetch_assoc($PurchaseInvoiceResult2))
						...
						$ppquery="select * from purchaseinvoice_product_dummy where purchase_invoiceid=".$row['purchase_invoiceid']." and rate=".$row['rate']."";
...
<?php
 $PurchaseInvoiceResult22 = mysqli_query($con,$PurchaseInvoiceQuery);
